...
const CreateQuiz = () => {
    ...
    const { loading: loadTemp, error: errTemp, data: questionTemp } = useQuery(
        FETCH_COLLECTIONS
    );
    ...
    useEffect(() => {
        if (questionTemp) {
            ...
            const filteredTemp = questionTemp.templates.filter(
    ...
    const handleGame = () => {
        ...
        if (questions.length < 1) {
            return MySwal.fire({
                position: "center",
                icon: "error",
                title: "Please add question first!",
    ...
    const handleClick = () => {
        ...
        if (!pointQuestion || Number(pointQuestion) === 0)
            return MySwal.fire({
                position: "center",
                icon: "warning",
                    ...
                    >
                        ...
                        {collections.length < 1 ? (
                            <h5
                                ...
                                style={{ color: "grey" }}
                            >
                                Check the save collection button to save your
                                questions here.
                            </h5>
                        ) : (
                ...
                <Col xs="7" className="ml-4">
                    <div>
                        <Form className="questionForm">
                            ...
                            <FormGroup className="d-flex flex-column">
                                <Col xs="12" className="d-flex">
                                    <Label className="align-self-center mr-3">
                                        Point
                                    </Label>
                                    <Input
                                        style={{ width: "200px" }}
                                        value={pointQuestion}
                                        onChange={(e) =>
                                            setPointQuestion(e.target.value)
                                        }
                                        type="number"
                                        placeholder="Range 0 - 100"
                                        min="0"
                                    />
                                    <small className="smallText align-self-center ml-3">
                                        Please fill range between 0 - 100
                                    </small>
                                </Col>
                            </FormGroup>
                            <FormGroup>
                        ...
                        <Form className="quizForm d-flex justify-content-center">
                            ...
                            >
                                <Label className="align-self-center mr-3 tex">
                                    Time Limit
                                </Label>
                                <Input
                                    value={timer}
                                    ...
                                    min="0"
                                />
                                <small className="smallText mt-2">
                                    Please fill timer in seconds
                                </small>
                                ...
                                <Input
                                    ...
                                    type="text"
                                    placeholder="Math for Beginners.."
                                />
